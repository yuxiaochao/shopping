			...
			<form class="form-horizontal">
				<fieldset>
					<div class="control-group">
						...
						<div class="controls">
							<input class="input-xlarge focused" id="baus002" type="text" >
						</div>
					</div>
					<div class="control-group">
						<label class="control-label" for="baus003">密码</label>
						<div class="controls">
							<input class="input-xlarge focused" id="baus003" type="text" >
						</div>
					</div>
					
					<div class="form-actions">
						<button type="button" class="btn btn-primary" id="backInsertSave">保存</button>
