			...
			<form class="form-horizontal">
				<fieldset>
					<div class="control-group">
						...
						<div class="controls">
							<input class="input-xlarge focused" id="prod002" type="text" value="${productInfo.prod002}">
						</div>
					</div>
					<div class="control-group">
						<label class="control-label" for="focusedInput">现价</label>
						<div class="controls">
							<input class="input-xlarge focused" id="prod003" type="text" value="${productInfo.prod003}">
						</div>
					</div>
					<div class="control-group">
						<label class="control-label" for="focusedInput">原价</label>
						<div class="controls">
							<input class="input-xlarge focused" id="prod004" type="text" value="${productInfo.prod004}">
						</div>
					</div>
					<!-- <div class="control-group">
					...
					<div class="control-group">
						...
						<div class="controls">
							<img alt="" src="${productInfo.prod005}" style="width: 226px;height: 179.76px"><br><br><br>
							<input class="input-file uniform_on" accept="image/png,image/jpeg,image/gif" name="myfiles" id="myfiles" type="file">
						</div>
					</div>
					<div class="control-group">
						...
						<div class="controls">
							<input class="input-xlarge focused" id="prod009" type="text" value="${productInfo.prod009}">
						</div>
					</div>
					<div class="control-group">
					...
					<div class="control-group">
						...
						<div class="controls">
							<input class="input-xlarge focused" id="prod011" type="text" value="${productInfo.prod011}">
						</div>
					</div>
					<div class="control-group">
					...
					<div class="control-group hidden-phone">
						...
						<div class="controls">
							<textarea class="cleditor" id="prod006" rows="3" >${productInfo.prod006}</textarea>
						</div>
					</div>
					<div class="form-actions">
						<button pk="${productInfo.prod001}" type="button" class="btn btn-primary" id="updateSave">保存</button>
